...
@Slf4j
public class ConsumeEventLambda extends KafkaBase implements RequestHandler<KafkaEvent, Void> {
    private final Deserializer<?> deserializer = new AWSKafkaAvroDeserializer(Map.of(
            ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class.getName(),
            ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, AWSKafkaAvroDeserializer.class.getName(),
            AWSSchemaRegistryConstants.AWS_REGION, System.getenv(AWS_REGION_PROP),
